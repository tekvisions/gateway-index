...
SITE_URL = "https://gateway.kymatalabs.com"
...
KSTRIP = ('<div class="kstrip"><div class="wrap">'
          ...
          '</div></div>')
NODE = '<span class="node"><i></i><i></i><i></i></span>'
...
<header><div class="wrap head-row">
  <div class="brand"><a href="/">{NODE}<span class="disp">Gateway <em>Index</em></span></a></div>
...
<footer><div class="wrap foot-row">
  <div class="blurb">{SITE_NAME} is a self-updating map of the LLM routing layer — gateways, proxies & routers — recomputed daily from live GitHub signals. Part of <a href="https://indexes.kymatalabs.com">The Living Indexes</a> by Kymata Labs.</div>
